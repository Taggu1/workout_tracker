...
const DaySchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'Exercise': ExerciseSchema, r'ESet': ESetSchema},
  getId: _dayGetId,
...
void _daySerialize(
  ...
  writer.writeBool(offsets[2], object.template);
...
Day _dayDeserialize(
  ...
  final object = Day(
    ...
    exercises: reader.readObjectList<Exercise>(
        ...
        [],
    id: id,
    template: reader.readBoolOrNull(offsets[2]) ?? false,
...
extension DayQueryFilter on QueryBuilder<Day, Day, QFilterCondition> {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'exercises',
        0,
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'exercises',
        0,
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> templateEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'template',
        value: value,
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleEqualTo(
    String? value, {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
  ...
  QueryBuilder<Day, Day, QAfterFilterCondition> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'title',
        value: '',
...
extension DayQueryObject on QueryBuilder<Day, Day, QFilterCondition> {
  QueryBuilder<Day, Day, QAfterFilterCondition> exercisesElement(
...
extension DayQuerySortBy on QueryBuilder<Day, Day, QSortBy> {
  ...
  QueryBuilder<Day, Day, QAfterSortBy> sortByTemplate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'template', Sort.asc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> sortByTemplateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'template', Sort.desc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DayQuerySortThenBy on QueryBuilder<Day, Day, QSortThenBy> {
  ...
  QueryBuilder<Day, Day, QAfterSortBy> thenByTemplate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'template', Sort.asc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> thenByTemplateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'template', Sort.desc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Day, Day, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension DayQueryWhereDistinct on QueryBuilder<Day, Day, QDistinct> {
  ...
  QueryBuilder<Day, Day, QDistinct> distinctByTemplate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'template');
    });
  }

  QueryBuilder<Day, Day, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DayQueryProperty on QueryBuilder<Day, Day, QQueryProperty> {
  ...
  QueryBuilder<Day, List<Exercise>, QQueryOperations> exercisesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'exercises');
    });
  }

  QueryBuilder<Day, bool, QQueryOperations> templateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'template');
    });
  }

  QueryBuilder<Day, String?, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
